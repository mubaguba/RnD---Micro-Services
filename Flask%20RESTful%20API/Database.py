...
with sqlite3.connect('C:/Users/Muba/PycharmProjects/API practise/practise.db') as connection:
    c = connection.cursor()
    c.execute("""CREATE TABLE IF NOT EXISTS User(User_ID INTEGER PRIMARY KEY,
    FirstName text, LastName text)""")
    c.execute("""CREATE TABLE IF NOT EXISTS Todo(todo_ID INTEGER PRIMARY KEY, UserID INTEGER, details text,
